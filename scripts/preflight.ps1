...
Purpose: Read-only toolchain check for the Explorer Welcome POC.
...
$results = @(
    ...
    [pscustomobject]@{ Tool = 'SignTool'; Available = Test-Path 'C:\Program Files (x86)\Windows Kits\10\bin\10.0.26100.0\x64\signtool.exe'; Path = '10.0.26100.0\x64\signtool.exe' },
